-- ============================================
-- TEST DATA — Insert + Delete pattern
...
VALUES
  ('Atacadão Central', 'João', '(11) 3000-1111'),
  ('Distribuidora de Farinhas', 'Maria', '(11) 3000-2222'),
  ('Laticínios São Paulo', 'Carlos', '(11) 3000-3333');
-- IDs: 1, 2, 3
...
VALUES
  ...
  ('ft_test_04', 'prod_test_01', 'mat_test_06', 0.100, 3),  -- 100ml óleo
  ('ft_test_05', 'prod_test_01', 'mat_test_05', 1.000, 5),  -- 1 ovo
  -- Brigadeiro (10 unidades)
  ('ft_test_06', 'prod_test_02', 'mat_test_02', 0.200, 1),  -- 200g açúcar
  ...
  ('ft_test_10', 'prod_test_03', 'mat_test_02', 0.250, 1),  -- 250g açúcar
  ('ft_test_11', 'prod_test_03', 'mat_test_06', 0.150, 3),  -- 150ml óleo
...
VALUES
  ...
  ('ped_test_02', 'cli_test_02', NOW() + INTERVAL '2 days', 2, 'Festas de aniversário', 90.00, 'Admin'),
  ('ped_test_03', 'cli_test_03', NOW() + INTERVAL '5 days', 1, 'Bolo para sábado',   45.00, 'Admin');
...
INSERT INTO estoque_produtos (id, produto_id, quantidade_disponivel, quantidade_reservada, quantidade_minima, lote, data_validade)
VALUES
  ('est_test_01', 'prod_test_01', 20, 10, 10, 'LOTE-T1', NOW() + INTERVAL '3 days'),
  ('est_test_02', 'prod_test_02', 15, 0,  5,  'LOTE-T2', NOW() + INTERVAL '5 days');
